...
//        public bool Excute(TaskFlowManagement.CurrentProcessTask TaskJob, IUserInterfaceReport TaskReport)
//        {
...
//                                    break;
//                                default:
//                                    TaskReport.On_TaskJob_Finished(TaskJob);
//                                    return false;
//                            }
//                            break;
...
//                                                    {
//                                                        AbortTask( TaskReport,TaskJob, nd, "S0300007");//Arm1 上已經有 wafer
                                                       
//                                                        return false;
//                                                    }
//                                                    else if (nd.L_Hold_Status.Equals("HLD") && nd.LArmActive)
//                                                    {
//                                                        AbortTask( TaskReport,TaskJob, nd, "S0300009");//Arm2 上已經有 wafer
...
//                                                    if (nd.R_Presence)
//                                                    {
//                                                        AbortTask( TaskReport,TaskJob, nd, "S0300004");//Aligner 上已經有 wafer
...
//                                    break;
//                                case 4:
//                                    TaskReport.On_TaskJob_Ack(TaskJob);
...
//                                        if (rb.Enable)
//                                        {
//                                            TaskJob.CheckList.Add(new TaskFlowManagement.ExcutedCmd(rb.Name, "EXCUTED", new Transaction().SetAttr(TaskJob.Id, Transaction.Command.RobotType.Servo, "0")));
//                                        }
//                                    }
//                                    break;
//                                case 5:
...
//                                    {
//                                        AbortTask( TaskReport,TaskJob, Target, "S0300015");
//                                        return false;
//                                    }
//                                    else if (Target.Busy)
//                                    {
//                                        AbortTask( TaskReport,TaskJob, Target, "S0300010");
//                                        return false;
//                                    }
//                                    else
//                                    {
...
//                                    {
//                                        AbortTask( TaskReport,TaskJob, Target, "S0300041");
//                                        return false;
//                                    }
//                                    else if (Target.Busy)
//                                    {
...
//                                                    {
//                                                        AbortTask( TaskReport,TaskJob, Target, "S0300156");
//                                                        return false;
//                                                    }
//                                                    break;
//                                                case "LOADLOCK":
...
//                                                    AbortTask( TaskReport,TaskJob, Target, "S0300018");
//                                                    return false;
//                                            }
//                                        }
//                                        TaskReport.On_TaskJob_Ack(TaskJob);
...
//                                    //if (Target.Busy)
//                                    //{
//                                    //    AbortTask( TaskReport,TaskJob, Target, "S0300002");
//                                    //    return false;
//                                    //}
//                                    //else
//                                    //{
...
//                                    if (!Target.InitialComplete && !SystemConfig.Get().SaftyCheckByPass)
//                                    {
//                                        AbortTask( TaskReport,TaskJob, Target, "S0300017");
//                                        return false;
//                                    }
//                                    else if (!Target.OrgSearchComplete && !SystemConfig.Get().SaftyCheckByPass)
//                                    {
//                                        AbortTask( TaskReport,TaskJob, Target, "S0300043");
//                                        return false;
//                                    }
//                                    else if (Target.Busy)
//                                    {
...
//                                    if (!Target.InitialComplete && !SystemConfig.Get().SaftyCheckByPass)
//                                    {
//                                        AbortTask( TaskReport,TaskJob, Target, "S0300168");
//                                        return false;
//                                    }
//                                    else
//                                    {
...
//                                        {
//                                            AbortTask( TaskReport,TaskJob, Target, "S0300166");
//                                            return false;
//                                        }
...
//                                    else if (!Target.OrgSearchComplete && !SystemConfig.Get().SaftyCheckByPass)
//                                    {
//                                        AbortTask( TaskReport,TaskJob, Target, "S0300169");
//                                        return false;
//                                    }
//                                    else
//                                    {
...
//                                    {
//                                        AbortTask( TaskReport,TaskJob, Target, "S0300142");
//                                        return false;
//                                    }
//                                    else
//                                    {
...
//                                    {
//                                        AbortTask( TaskReport,TaskJob, Target, "S0300167");
//                                        return false;
//                                    }
//                                    else
//                                    {
...
//                                            {
//                                                AbortTask( TaskReport,TaskJob, Target, "S0300174");
//                                                return false;
//                                            }
//                                            else
//                                            {//Robot mapping
...
//                                    {
//                                        AbortTask( TaskReport,TaskJob, Target, "S0300173");
//                                        return false;
//                                    }
//                                    else
//                                    {
...
//                                    {
//                                        AbortTask( TaskReport,TaskJob, Target, "S0300145");
//                                        return false;
//                                    }
//                                    else
//                                    {
...
//                                    {
//                                        AbortTask( TaskReport,TaskJob, Target, "S0300144");
//                                        return false;
//                                    }
//                                    else
//                                    {
...
//                                    else if (Target.Latch_Open && !SystemConfig.Get().SaftyCheckByPass)
//                                    {
//                                        AbortTask( TaskReport,TaskJob, Target, "S0300143");
//                                        return false;
//                                    }
//                                    else
//                                    {
...
//                                    {
//                                        AbortTask( TaskReport,TaskJob, Target, "S0300162");
//                                        return false;
//                                    }
//                                    if (!GetSafetyCheck(TaskJob, TaskReport))
//                                    {
...
//                                        TaskJob.CheckList.Add(new TaskFlowManagement.ExcutedCmd(Target.Name, "FINISHED", new Transaction().SetAttr(TaskJob.Id, Transaction.Command.RobotType.Put, "", "LOADLOCK01", "1", TaskJob.Params["@Arm"])));
//                                    }
//                                    else
//                                    {
...
//                                    {
//                                        if (Target.JobList.ContainsKey(TaskJob.Params["@Arm"]))
//                                        {
//                                            MoveWip(Target.Name, TaskJob.Params["@Arm"], "LOADLOCK01", "1");
//                                            TaskJob.CheckList.Add(new TaskFlowManagement.ExcutedCmd(Target.Name, "FINISHED", new Transaction().SetAttr(TaskJob.Id, Transaction.Command.RobotType.Put, "", "LOADLOCK01", "1", TaskJob.Params["@Arm"])));
//                                        }
...
//                                    if (Target.JobList.Count != 0)
//                                    {
//                                        TaskJob.Params["@Slot"] = Target.JobList[TaskJob.Params["@Arm"].Equals("1") ? "2" : "1"].DestinationSlot;
...
//                                        else
//                                        {
//                                            MoveWip(Target.Name, TaskJob.Params["@Arm"].Equals("1") ? "2" : "1", TaskJob.Params["@Position"], TaskJob.Params["@Slot"]);
//                                        }

//                                        TaskJob.CheckList.Add(new TaskFlowManagement.ExcutedCmd(Target.Name, "FINISHED", new Transaction().SetAttr(TaskJob.Id, Transaction.Command.RobotType.Put, "", TaskJob.Params["@Position"], TaskJob.Params["@Slot"], TaskJob.Params["@Arm"].Equals("1") ? "2" : "1")));
//                                    }
//                                    break;
//                                case 4:
...
//                                                    select each;
//                                    if (Target.JobList.Count == 0 && Available.Count() == 0 && NodeManagement.Get("LOADLOCK01").JobList.Count == 1)
//                                    {

//                                        MoveWip("LOADLOCK01", "1", Target.Name, "1");
//                                        TaskJob.CheckList.Add(new TaskFlowManagement.ExcutedCmd(Target.Name, "FINISHED", new Transaction().SetAttr(TaskJob.Id, Transaction.Command.RobotType.Get, "", "LOADLOCK01", "1", "1")));
//                                    }
//                                    else
//                                    {
//                                        newAct = new Node.ActionRequest();
...
//                                                where NodeManagement.Get(each.Position).Type.Equals("ALIGNER")
//                                                select each;
//                                    if (Target.JobList.Count == 1 && Available.Count() == 0 && NodeManagement.Get("LOADLOCK01").JobList.Count == 0)
//                                    {
//                                        TaskJob.Params["@Slot"] = Target.JobList["1"].DestinationSlot;
//                                        MoveWip(Target.Name, "1", TaskJob.Params["@Position"], TaskJob.Params["@Slot"]);
//                                        TaskJob.CheckList.Add(new TaskFlowManagement.ExcutedCmd(Target.Name, "FINISHED", new Transaction().SetAttr(TaskJob.Id, Transaction.Command.RobotType.Put, "", TaskJob.Params["@Position"], TaskJob.Params["@Slot"], "1")));
//                                    }
//                                    break;
//                                default:
//                                    TaskReport.On_TaskJob_Finished(TaskJob);
...
//                        bool re = this.Excute(TaskJob, TaskReport);
//                        if (!re)
//                        {
//                            return false;
//                        }
...
//        }
//        private bool CheckEMO(TaskFlowManagement.CurrentProcessTask TaskJob, IUserInterfaceReport TaskReport)
//        {
//            bool result = true;
//            if (!SystemConfig.Get().SaftyCheckByPass)
//            {
...
//            return result;
//        }
//        private bool GetSafetyCheck(TaskFlowManagement.CurrentProcessTask TaskJob, IUserInterfaceReport TaskReport)
//        {
//            if (!SystemConfig.Get().SaftyCheckByPass)
//            {
...
//                {
//                    AbortTask( TaskReport,TaskJob, Target, "S0300007");//Arm1 上已經有 wafer
//                    return false;
//                }
//                if ((Arm.Equals("2") || Arm.Equals("3")) && Target.L_Hold_Status.Equals("HLD"))
//                {
//                    AbortTask( TaskReport,TaskJob, Target, "S0300009");//Arm2 上已經有 wafer
...
//                                {
//                                    AbortTask( TaskReport,TaskJob, Target, "S0300162");//取片來源地點無Wafer資料
//                                    TaskJob.HasError = true;
//                                    return false;
//                                }
//                                break;
...
//                        {
//                            AbortTask( TaskReport,TaskJob, Target, "S0300003");//Aligner上沒有 wafer
//                            TaskJob.HasError = true;
//                            return false;
//                        }
//                        break;
...
//            return true;
//        }
//        private bool PutSafetyCheck(TaskFlowManagement.CurrentProcessTask TaskJob, IUserInterfaceReport TaskReport)
//        {
//            if (!SystemConfig.Get().SaftyCheckByPass)
//            {
//                Node Target = NodeManagement.Get(TaskJob.Params["@Target"]);
...
//                {
//                    AbortTask( TaskReport,TaskJob, Target, "S0300006");//Arm1 上無 wafer
//                    TaskJob.HasError = true;
//                    return false;
//                }
//                if ((Arm.Equals("2") || Arm.Equals("3")) && Target.L_Hold_Status.Equals("REL"))
//                {
//                    AbortTask( TaskReport,TaskJob, Target, "S0300008");//Arm2 上無 wafer
//                    TaskJob.HasError = true;
//                    return false;
//                }
//                switch (Position.Type.ToUpper())
...
//                        if (!Position.IsMapping)
//                        {
//                            AbortTask( TaskReport,TaskJob, Target, "S0300156");//Load Port 尚未執行過 mapping
//                            TaskJob.HasError = true;
//                            return false;
//                        }
//                        switch (Arm)
...
//                                if (Position.JobList[Slot].MapFlag || Position.JobList[Slot].ErrPosition)
//                                {
//                                    AbortTask( TaskReport,TaskJob, Target, "S0300171");//放片目的地已有Wafer
//                                    TaskJob.HasError = true;
//                                    return false;
//                                }
//                                break;
...
//                        if (Position.R_Presence)
//                        {
//                            AbortTask( TaskReport,TaskJob, Target, "S0300004");//Aligner 上已經有 wafer
//                            TaskJob.HasError = true;
//                            return false;
//                        }
//                        break;
...
//            }
//        }
//        private void AbortTask( IUserInterfaceReport TaskReport,TaskFlowManagement.CurrentProcessTask TaskJob, Node Node, string Message)
//        {
//            TaskReport.On_Alarm_Happen(new AlarmManagement.Alarm(Node, Message));
//            TaskJob.HasError = true;
//            TaskReport.On_TaskJob_Aborted(TaskJob);
